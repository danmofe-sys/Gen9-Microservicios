package com.molina.camiones.models;

import com.molina.camiones.enums.Marcas;
import com.molina.camiones.enums.Tipos;
...
public class Camion {
    ...
    @SequenceGenerator(sequenceName = "customer_seq1", allocationSize = 1, name =
    "CUST_SEQ1")
